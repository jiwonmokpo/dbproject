<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page
	import="java.util.*, java.io.PrintWriter, javax.mail.internet.*, javax.mail.*"%>
...
int emailChecked = memberDAO.getUserEmailChecked(userID);
if (emailChecked == 1) {
	PrintWriter script = response.getWriter();
	script.println("<script>");
...
//받는 사람
String to = memberDAO.getUserEmail(userID);
//이메일 제목, 내용
...
<body>
	...
	<footer class="bg-dark mt-4 p-5 text-center" style="color: #FFFFFF;">
		Copyright &copy; 2022 jiwon Rights Reserved. </footer>
	<!-- jQuery 추가 -->
