...
<%@ page import="bbscomment.BbscommentDAO" %><%--데이터베이스 접근 객체 가져오기 --%>
		...
		<div class="row">
			<form method="post" action="commentUpdateAction.jsp?bbsID=<%=bbsID%>&commentID=<%=commentID%>">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					<tbody>
						<tr>
							<td><input type="text" class="form-control" placeholder="댓글 쓰기" name="commentContent" maxlength="300" value=<%= bbscomment.getCommentContent() %>></td>
						</tr>
					</tbody>
				</table>
